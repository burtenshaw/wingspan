...
CUDA_VISIBLE_DEVICES=0 python train_bert_span.py --method_name bert_span --hparams
CUDA_VISIBLE_DEVICES=0 python train_bert_ngram.py --method_name bert_ngram --hparams
