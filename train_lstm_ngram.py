...
while now < tomorrow:
    ...
    X_train, y_train, X_val, y_val, X_test, y_test, embedding_matrix = make_context_data(X_y, pre = pre, post = post, word = word)
    ...
    run_dir = LOG_DIR + '/' + METHOD_NAME + 'ROUND_2' + param_str
