...
data['tokens'] = data.text.apply(list)
# data['character_mask'] = data.spans.apply(make_character_mask)
# data['word_mask'] = data.apply(make_word_mask, axis = 1)
#%%
data.drop(columns = ['doc_ents'], inplace = True)
#%%
# categorical targets
